...
cp -rf /ql/repo/anyung533_jojo-all/* /ql/scripts/
cp -rf /ql/repo/anyung533_jojo-all/* /ql/scripts/anyung533_jojo-all/
cp -rf /ql/repo/anyung533_jojo-all/pull.sh /ql/config/
